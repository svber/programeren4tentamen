...
public class Config {
    ...
    public static final String URL_FILMS = "https://programeren4tentamen.herokuapp.com/api/v1/films/5";
    public static final String URL_CUSTOMERS = "https://programeren4tentamen.herkuapp.com/api/v1/register";
